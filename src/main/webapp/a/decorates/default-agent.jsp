...
<div id="wrapper">
    <div>
        <div id="topBar">
            <div class="container">
                    <div class="col-lg-12">
                        <ul class="top-links list-inline pull-left hidden-xs hidden-sm">
                            <li><a>微推 v2.0</a></li>
                            <li><a>一款裂变式精准整合营销系统</a></li>
                        </ul>

                        <!-- right -->
                        <ul class="top-links list-inline pull-right">
                            <li class="text-welcome">${account.companyInfo.companyName}</li>
                            <li>
                                <a class="no-text-underline" href="#"><i class="fa fa-user"></i> <strong>${account.userName}</strong></a>
                            </li>
                        </ul>
                </div>
            </div>
                        ...
                        <nav class="nav-main">
                            <ul id="topMain" class="nav nav-pills nav-main">
                                <li class="active"><!-- HOME -->
                                    <a class="active" href="${ctx}/agent/${agentId}">
                                        微信裂变
                                    </a>
                                </li>
                                <li><!-- HOME -->
                                    <a class="" href="${ctx}/agent/yellowpages">
                                        商户库
                                    </a>
                                </li>
                                <li><!-- HOME -->
                                    <a class="" href="${ctx}/agent/${agentId}/memberApply">
                                        客户开户
                                    </a>
                                </li>
                            </ul>
