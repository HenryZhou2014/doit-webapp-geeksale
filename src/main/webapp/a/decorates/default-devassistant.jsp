...
<head>
    ...
    <title><decorator:title/> aa | <fmt:message key='webapp.name'/></title>
                        ...
                        <form id="loginForm" class="form-horizontal" <%--action="${ctx}/j_security_check" method="post" --%> style="border-width: 0;">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 socials text-left"><!-- more buttons: ui-buttons.html -->
                                    ...
                                    <a href="https://api.weibo.com/oauth2/authorize?client_id=731429745&redirect_uri=http%3A%2F%2Fwww.cmxgc.com%2Fsina%2Fcallback&state=27a90db4002a656b636f711a843ed19e&display=default&response_type=code" class="social-icon social-youtube" data-toggle="tooltip" data-placement="top" title="微博">
