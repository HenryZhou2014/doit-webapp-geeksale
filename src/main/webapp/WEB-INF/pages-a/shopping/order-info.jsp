    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12">
                <p>
                    ${address.name}（${address.phoneNum}） ${address.provinceName}（${address.cityName}） ${address.address}
                </p>
            </div>
            ...
            <div class="col-lg-12 col-sm-12">
                ...
                <div style="border-bottom: 1px solid #eaeaea;">
                    <table class="table table-striped table-hover margin-0" style="margin-bottom: 0;">
                        ...
                        <c:forEach items="${items}" var="goodsOrderProduct">
                            <tr>
                                <td>
                                    ...
                                    <div>
                                        <h4><a href="${ctx}/mall/item-2387.html">${goodsOrderProduct.name}</a></h4>
                                        <div>作者:${goodsOrderProduct.author}</div>
                                        <div>ISBN:${goodsOrderProduct.ISBN}</div>
                                    </div>
                                </td>
                                <td>
                                    ${goodsOrderProduct.productNum}&times;
                                    ${goodsOrderProduct.price}
                                </td>
                                <td>
                                    ${goodsOrderProduct.productNum*goodsOrderProduct.price}
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
        ...
        <div class="callout alert alert-danger margin-top-60 margin-bottom-60">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 text-right"><!-- right btn -->
                    <a href="${ctx}/payment/pay?id=${order_id}" rel="nofollow" target="_blank" class="btn btn-danger btn-lg">立即支付</a>
                </div><!-- /right btn -->
