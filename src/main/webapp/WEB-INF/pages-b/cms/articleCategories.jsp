...
<head>
    <title>内容分类管理</title>
    <meta name="heading" content="<fmt:message key='articleCategoryList.heading'/>"/>
            ...
            <div class="modal-body" id="userForm" style="min-height:300px;max-height: 455px;overflow: auto;">
                <form class="form-horizontal" id="newItemForm">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <i class="fa fa-align-left"></i> <span id="rootName">文章分类</span>
                        </div>
                    </div>
...
//            "order": [[4, "asc"]],
            ...
            "ajax": {
                "url": "${ctx}/backend/json/cms/articleCategories",
                "type": "GET",
                "dataType": "json",
                "data": {
                    include : true,
    ...
    function deleteItems() {
        ...
        BootstrapDialog.show({
            ...
            message: "确认删除所选项(若该分类包含子分类，那么子分类也将一并删除)？<div><i class='text-info'>该分类下的文章将被移到未分类下</i></div>",
            buttons: [{
                label: '取消',
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/cms/articleCategories/deleteItems",
                            data: {
                                checkId: function () {
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/cms/articleCategories/publishItems",
                            data: {
                                checkId: function () {
                                    return $("input[name='checkId']:checked").checkvalues();
                                }
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/cms/articleCategories/unpublishItems",
                            data: {
                                checkId: function () {
                                    return $("input[name='checkId']:checked").checkvalues();
                                }
    ...
    function seqNoExchange(id1, id2){
        $.ajax({
            url: "${ctx}/backend/json/cms/articleCategories/seqNoExchange",
            data: {
                id1 : id1,
                id2 : id2
            },
    ...
    function saveNewItems() {
        ...
        $.ajax({
            url: "${ctx}/backend/json/cms/articleCategories/create",
            data: formData,
            type: "POST",
            dataType: "json",
            success: function (data) {
    ...
    function updateItemInfo() {
        ...
        $.ajax({
            url: "${ctx}/backend/json/cms/articleCategories/update",
            data: {
                id: id,
                aliasName: aliasName,
                title: title,
