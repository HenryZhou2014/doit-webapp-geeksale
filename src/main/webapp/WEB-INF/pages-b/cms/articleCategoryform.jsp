...
<head>
    <title><fmt:message key="articleCategoryDetail.title"/></title>
    <meta name="heading" content="<fmt:message key='articleCategoryDetail.heading'/>"/>
    <meta name="module-group" content="content-management"/>
    <meta name="module" content="article-categories"/>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="${ctx}/backend/cms/articleCategories.html">文章分类管理</a>
            </li>
            <li class="active">
                <strong>新增</strong>
            </li>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a id="toolbar_new" href="${ctx}/backend/cms/articleCategoryform.html">
                            <i class="fa fa-plus-circle"></i> 增加
                        </a>
                    </div>
                </div>
                <div class="ibox-content">
                    <form:form commandName="articleCategory" class="form-horizontal" method="post" action="articleCategoryform" id="articleCategoryForm">
                        <form:errors path="*" cssClass="error" element="div"/>
                        <form:hidden path="id"/>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><fmt:message key="articleCategory.parent.title"/></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><fmt:message key="articleCategory.title"/></label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><fmt:message key="articleCategory.aliasName"/></label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                        ...
                        <div class="form-group">
                            <appfuse:label styleClass="col-sm-2 control-label" key="articleCategory.seqNo"/>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                        ...
                        <div class="form-group">
                            <appfuse:label styleClass="col-sm-2 control-label" key="articleCategory.memo"/>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="${ctx}/backend/cms/articleCategories.html">取消</a>
...
//        initToolBarActions();
        ...
        $('#articleCategoryForm').bootstrapValidator({
                ...
                aliasName: {
                    validators: {
                        ...
                        remote: {
                            ...
                            type: 'GET',
                            url: '${ctx}/backend/json/cms/articleCategoryform/aliasNameCheck',
                            dataType: 'json',
                            message: '该别名已被使用',
                            delay: 1000
                        }
                    ...
                    validators: {
                        ...
                        remote: {
                            ...
                            type: 'GET',
                            url: '${ctx}/backend/json/cms/articleCategoryform/seqNoCheck',
                            dataType: 'json',
                            message: '该顺序号已被使用',
                            delay: 1000
                        }
...
//            submitMessage();
    ...
    function action_reload(){
        location.href='articleCategoryform?id=${articleCategory.id}';
    }
</script>
