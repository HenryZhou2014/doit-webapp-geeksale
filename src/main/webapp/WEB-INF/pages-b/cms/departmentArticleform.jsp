...
<head>
    ...
    <meta name="module" content="department-articles"/>
...
<c:set var="articleTitle" value="新增部门资讯"/>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="${ctx}/backend/cms/articles.html"><i class="fa fa-mail-reply"></i> 返回</a>
                    </div>
                </div>
                <div class="ibox-content">

                    <form:form commandName="article" method="post" action="departmentArticleform" id="articleForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 right-panels">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <div class="form-group">
                                            <div class="col-sm-3">附件</div>
                                            <div class="col-sm-9">
                                                <input type="file" name="lijfafe"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <label><input type="radio"/>所有人可下载</label>
                                                <label><input type="radio"/>限会员下载</label>
                                                <label><input type="radio"/>限密码下载</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
