                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 right-panels">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <ul id="ul-attachments" class="list-unstyled">
                                                    <c:forEach items="${fileInfos}" var="fileItem">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <div class="form-group">
                                            <div class="col-sm-3">Meta描述</div>
                                            <div class="col-sm-9">
                                                <form:input path="metaDesc" id="metaDesc" cssClass="form-control" maxlength="256"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3">Meta关键字</div>
                                            <div class="col-sm-9">
                                                <form:input path="metaKey" id="metaKey" cssClass="form-control" maxlength="256"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
