            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="${ctx}/backend/cms/notificationform.html">
...
//                {"data": "title"},
                ...
                {"data": "author",title:"作者", "bSortable": false},
                ...
                {"data": "publishFlag","bSortable": false,title:"状态",style:"width:80px;","bSortable": false},
                {"data": "publishDate",title:"发布信息", "bSortable": false},
...
//                        return "<div class='imageWrapper'><img class='img-responsive block-center' src=\"" + row.thumbImageUrl + "\"/></div>";
                ...
                {
                    "render": function (data, type, row) {
                        return "<a class='btn btn-primary btn-xs' href=\"notificationform?id=" + row.id + "\">编辑</a>";
