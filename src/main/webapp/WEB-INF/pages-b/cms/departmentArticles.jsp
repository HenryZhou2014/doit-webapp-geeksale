            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="${ctx}/backend/cms/departmentArticleform.html">
...
//                        return "<div class='imageWrapper'><img class='img-responsive block-center' src=\"" + row.thumbImageUrl + "\"/></div>";
                ...
                {
                    "render": function (data, type, row) {
                        return "<a class='btn btn-primary btn-xs' href=\"departmentArticleform?id=" + row.id + "\">编辑</a>";
