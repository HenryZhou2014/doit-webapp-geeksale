...
<head>
    ...
    <meta name="module" content="notifications"/>
...
<c:set var="articleTitle" value="新增公告信息"/>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a id="toolbar_new" href="${ctx}/backend/cms/notificationform.html">
                        ...
                        <a href="${ctx}/backend/cms/notifications.html"><i class="fa fa-mail-reply"></i> 返回</a>
                    </div>
                </div>
                <div class="ibox-content">

                    <form:form commandName="article" method="post" action="notificationform" id="articleForm"
