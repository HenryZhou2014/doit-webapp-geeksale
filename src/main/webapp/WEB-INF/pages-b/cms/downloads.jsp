            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="${ctx}/backend/cms/downloadform.html">
                            ...
                            <div class="queryform">
                                ...
                                <form id="productInfoform" class="form-horizontal" style="margin-bottom: 5px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <input name="author" id="author" class="form-control" maxlength="60"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 text-center">
                                            <label>状态</label>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <select name="publishFlag" class="form-control">
...
<script id="attachmentInfoTemplate" type="text/html">
    <div class="row">
        <div class="col-lg-12">
            {{if (attachmentNum > 0)}}
            <a><label class="label label-default"><i class="fa fa-download"></i> {{attachmentNum}}</label></a>
            {{/if}}
        </div>
    </div>
</script>

<script id="downloadTemplate" type="text/html">
    {{if (scope == 'm')}}
        <div>会员</div>
    {{else}}
        {{if (scope == 'p')}}
...
//                {"data": "title"},
                ...
                {"data": "attachmentNum","bSortable": false, title:"附件"},
                {"data": "attachmentNum","bSortable": false, title:"下载"},
            ...
            "ajax": {
                url: "${ctx}/backend/json/cms/downloads",
                type: "POST",
                dataType: "json",
                data: {
                    rootCategory: "download",
                    categoryId: function () {
                    ...
                    publishStatus: function () {
                        return $("select[name='publishFlag").val();
                    }
                }
            },
            "columnDefs": [
...
//                        return "<div class='imageWrapper'><img class='img-responsive block-center' src=\"" + row.thumbImageUrl + "\"/></div>";
                ...
                {
                    "render": function (data, type, row) {
                        var html = template("attachmentInfoTemplate", row);
                        return html;
//                        return "<div class='imageWrapper'><img class='img-responsive block-center' src=\"" + row.thumbImageUrl + "\"/></div>";
                ...
                {
                    "render": function (data, type, row) {
                        var html = template("downloadTemplate", row);
                        return html;
//                        return "<div class='imageWrapper'><img class='img-responsive block-center' src=\"" + row.thumbImageUrl + "\"/></div>";
                ...
                {
                    "render": function (data, type, row) {
                        return "<a class='btn btn-primary btn-xs' href=\"downloadform?id=" + row.id + "\">编辑</a>";
