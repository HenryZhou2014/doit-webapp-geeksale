...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="${ctx}/backend/admin/users.html">用户账号管理</a>
            </li>
            <c:choose>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a id="toolbar_refresh" href="${ctx}/backend/user/accountform?id=${account.id}">
                ...
                <div class="ibox-content">
                    <form:form commandName="account" class="form-horizontal" method="post"
                               action="${ctx}/backend/user/accountform.html" id="userForm" autocomplete="false">
                        <form:hidden path="id"/>
                                ...
                                <div class="input-group">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty account.id}">
                                            <form:input path="accountName" id="accountName" autocomplete="off"
                                                        cssClass="form-control" cssErrorClass="form-control" maxlength="60"/>
                                        </c:when>
                                        <c:otherwise>
                                            <form:input path="accountName" id="accountName" disabled="true" readonly="true" autocomplete="off"
                                                        cssClass="form-control" cssErrorClass="form-control" maxlength="60"/>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                        ...
                        <c:if test="${empty account.id}">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <form:input path="passwd" id="passwd" cssClass="form-control" autocomplete="off" onfocus="this.type='password';"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:select path="departmentId" id="departmentId" cssClass="form-control"
                                            cssErrorClass="text medium error" items="${departmentList}" itemLabel="departmentName" itemValue="id"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-2" style="text-align: center;">
                                <a class="btn btn-white" href="${ctx}/backend/admin/users">返回</a>
...
//            e.preventDefault();
    ...
    function action_reload() {
        location.href = "${ctx}/admin/userform?id=${account.id}";
    }
