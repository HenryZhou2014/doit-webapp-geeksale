...
//            "order": [[1, "desc"]],
            ...
            "columns": [
                ...
                {"data": "parameterCode", class: "text-left width-300", "bSortable": false, title: "编号"},
                {"data": "parameterName", title: "名称", "bSortable": false},
                {"data": "groupName", title: "组", "bSortable": false},
                {"data": "parameterValue", title: "值", "bSortable": false},
            ...
            "ajax": {
                url: "${ctx}/backend/json/admin/parameters",
                type: "POST",
                dataType: "json",
                data: {
                    groupCode: function () {
...
//            var $selectedvalue = $("input[name='dataType']:checked").val();
        ...
        $("#toolbar_update_cache").click(function(){
            $.ajax({
                url: "${ctx}/backend/admin/parameters/updateCache",
                data: {
                },
                type: "POST",
                dataType: "json",
