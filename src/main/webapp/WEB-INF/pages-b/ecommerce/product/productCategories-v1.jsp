...
//            "scrollY": "600px",
            ...
            "columns": [
                {"data": "id",class: "text-center","bSortable": false, title:"<input type='checkbox' class='checkAll' checkTarget='checkId'/>", render: function(data, type, row){
                    return "<input type='checkbox' name='checkId' value=\"" + row.id + "\"/>";
                }},
                {"data": "seqNo",class: "text-center", "bSortable": false, title:"#"},
                {"data": "title","bSortable": false, title:"名称"},
                {"data": "aliasName","bSortable": false,title:"编号"},
                {"data": "id",title:"属性定义"},
                {"data": "id",title:"发布状态"},
                {"data": "id", visible:false,title:"创建信息"},
                {"data": "memo","bSortable": false,title:"备注"},
                {"data": "id","bSortable": false,title:"操作"}
            ],
            "ajax": {
                "url": "${ctx}/backend/json/ecommerce/product/productCategories",
                "type": "GET",
                "dataType": "json",
                "data": {}
            },
            "columnDefs": [
                 {
                    "render": function (data, type, row) {
                        var html = "<div class='cat-padding-" + row.treeLevel + "'>";
                        if (row.hasChild == "1") {
        ...
        $("#toolbar_new").bind("click", function(){
            ...
            $("#newItemForm #rootName").text("文章分类");
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/ecommerce/product/productCategories/deleteItems",
                            data: {
                                checkId: function () {
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/ecommerce/product/productCategories/publishItems",
                            data: {
                                checkId: function () {
                                    return $("input[name='checkId']:checked").checkvalues();
                                }
                            ...
                            success: function (data) {
                                ...
                                if (data && data.flag == "1") {
                                    mainDataTable.ajax.reload();
                                    toastSuccess("操作提示", "所选项目已经发布！");
                                }
                                else if (data && data.flag == "0") {
                                    toastError("操作提示", data.msg);
                                }
                                else {
                                    toastError("操作提示", "发布失败！");
                                }
                            }
                        });
                    }
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/ecommerce/product/productCategories/unpublishItems",
                            data: {
                                checkId: function () {
                                    return $("input[name='checkId']:checked").checkvalues();
                                }
                            ...
                            success: function (data) {
                                ...
                                if (data && data.flag == "1") {
                                    mainDataTable.ajax.reload();
                                    toastSuccess("操作提示", "所选项目已经取消发布！");
                                }
                                else if (data && data.flag == "0") {
                                    toastError("操作提示", data.msg);
                                }
                                else {
                                    toastError("操作提示", "取消发布失败！");
                                }
                            }
                        });
                    }
    ...
    function seqNoExchange(id1, id2) {
        $.ajax({
            url: "${ctx}/backend/json/ecommerce/product/productCategories/seqNoExchange",
            data: {
                id1: id1,
                id2: id2
            },
    ...
    function saveNewItems() {
        ...
        $.ajax({
            url: "${ctx}/backend/json/ecommerce/product/productCategories/create",
            data: formData,
            type: "POST",
            dataType: "json",
            success: function (data) {
    ...
    function updateItemInfo() {
        ...
        $.ajax({
            url: "${ctx}/backend/json/ecommerce/product/productCategories/update",
            data: {
                id: id,
                aliasName: aliasName,
                title: title,
