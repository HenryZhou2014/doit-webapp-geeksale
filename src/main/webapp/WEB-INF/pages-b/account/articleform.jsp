        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form:form commandName="article" method="post" action="${ctx}/backend/cms/saveArticle.html" id="articleForm"
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <form:select path="categoryId" cssClass="form-control"
                                                                 itemValue="${article.id}" itemLabel="${artilce.tilte}">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">图片作者</label>
                                            <div class="col-sm-10">
                                                <form:input path="authorImage" id="authorImage" cssClass="form-control"
                                                            cssErrorClass="text medium error" maxlength="32"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">摄影作者</label>
                                            <div class="col-sm-10">
                                                <form:input path="authorVideo" id="authorVideo" cssClass="form-control"
                                                            cssErrorClass="text medium error" maxlength="32"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">排版作者</label>
                                            <div class="col-sm-10">
                                                <form:input path="authorDecorate" id="authorDecorate" cssClass="form-control"
                                                            cssErrorClass="text medium error" maxlength="32"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">编辑发布时间</label>
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 text-center picturePanelWrapper pictureTemplate hidden">
                                                <div class="picturePanel">
                                                    ...
                                                    <div>
                                                        <a class="imageWrapper productImage" data-toggle="modal"
