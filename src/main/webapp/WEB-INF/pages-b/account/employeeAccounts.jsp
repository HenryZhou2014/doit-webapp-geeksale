            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a id="toolbar_new" href="${ctx}/backend/account/accountform">
...
//                        return "<a class='btn btn-primary btn-xs' href='javascript:void(0);' onclick=\"openItem(" + row.id + ");\">编辑</a>";
                        return "<a class='btn btn-primary btn-xs' href='${ctx}/backend/employeeaccount/accountform?id=" + row.id + "'>编辑</a>";
