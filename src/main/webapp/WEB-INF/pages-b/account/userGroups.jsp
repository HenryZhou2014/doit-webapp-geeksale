...
<head>
    ...
    <meta name="module" content="user-userGroups"/>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="${ctx}/backend/admin/roles.html">用户组管理</a>
            </li>
        </ol>
    </div>
</div>
                ...
                <div class="modal-body" id="userForm" style="min-height:300px;max-height: 455px;overflow: auto;">
                    <form class="form-horizontal" id="departmentInfoCreateForm">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <i class="fa fa-align-left"></i> <span id="rootName">用户组</span>
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        ...
        mainDataTable = $(".dataTables-example").on('init.dt', function () {
            ...
            $(".dataTables-example").on("click", ".btn_edit", function (element) {
                ...
                $("#departmentInfoEditForm input[name='groupCode']").val(code);
                $("#departmentInfoEditForm input[name='groupName']").val(name);
...
//            "order": [[2, "asc"]],
            ...
            "ajax": {
                "url": "${ctx}/backend/json/account/userGroups",
                "type": "GET",
                dataType: "json",
                "data": {}
            },
...
//            preSaveProcess();
    ...
    function initToolBarActions() {
        ...
        $("#toolbar_new").bind("click", function () {
            ...
            $("#departmentInfoCreateForm #rootName").text("用户组");
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/account/userGroups/deleteItems",
                            data: {
                                checkId: function () {
    ...
    function updateItemInfo() {
        ...
        var groupCode = $("#departmentInfoEditForm input[name='groupCode']").val();
        var groupName = $("#departmentInfoEditForm input[name='groupName']").val();
        var memo = $("#departmentInfoEditForm input[name='memo']").val();

        $.ajax({
            url: "${ctx}/backend/json/account/userGroups/update",
            data: {
                id: id,
                groupCode: groupCode,
                groupName: groupName,
    ...
    function saveNewDepartments() {
        ...
        $.ajax({
            url: "${ctx}/backend/json/account/userGroups/create",
            data: formData,
            type: "POST",
            dataType: "json",
            success: function (data) {
    ...
    function seqNoExchange(id1, id2){
        $.ajax({
            url: "${ctx}/backend/json/account/userGroups/seqNoExchange",
            data: {
                id1 : id1,
                id2 : id2
            },
