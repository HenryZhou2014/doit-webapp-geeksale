...
<head>
    ...
    <meta name="module" content="user-oem-accounts"/>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="${ctx}/backend/admin/users.html">会员账号管理</a>
            </li>
        </ol>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a id="toolbar_new" href="${ctx}/backend/account/accountform?id=${account.id}">
                ...
                <div class="ibox-content">
                    <form:form commandName="account" class="form-horizontal" method="post"
                               action="${ctx}/backend/account/accountform.html" id="accountForm" autocomplete="false">
                        <form:hidden path="id"/>
