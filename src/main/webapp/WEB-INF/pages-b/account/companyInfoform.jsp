...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="${ctx}/backend/ecommerce/product/productCategories.html">会员公司信息</a>
            </li>
            <li class="active">
                <strong>新增</strong>
            </li>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="${ctx}/backend/account/companyInfoes.html"><i class="fa fa-mail-reply"></i> 返回</a>
                    </div>
                </div>
                <div class="ibox-content">
                    <form:form commandName="companyInfo" class="form-horizontal" method="post" action="companyInfoform" id="companyInfoform">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                                    <form:input path="slogan" id="slogan" cssClass="form-control" cssErrorClass="text medium error" maxlength="30"/>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                                    <form:input path="linkPerson" id="linkPerson" cssClass="form-control" cssErrorClass="text medium error" maxlength="30"/>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">*</div>
                                    <form:input path="phoneNumber" id="phoneNumber" cssClass="form-control" cssErrorClass="text medium error" maxlength="30"/>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="${ctx}/backend/account/companyInfoes.html">取消</a>
