...
<head>
    ...
    <meta name="module" content="system-logs-access"/>
                            ...
                            <form id="productInfoform" class="form-horizontal" style="margin-bottom: 5px;">
                                <div class="row">
                                    <div class="col-lg-1 text-right">
                                        <label for="accountInfo">IP/账号</label>
                                    </div>
                                    <div class="col-lg-2">
...
//            "scrollY": "600px",
            ...
            "ajax": {
                "url": "${ctx}/backend/json/admin/logs/accessLogs",
                "type": "GET",
                "dataType": "json",
                "data": {
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/admin/logs/accessLogs/deleteItem",
                            data: {
                                checkId: itemId
                            },
        ...
        BootstrapDialog.show({
            ...
            buttons: [{
            ...
            },
                {
                    ...
                    action: function (dialogItself) {
                        $.ajax({
                            url: "${ctx}/backend/json/admin/logs/accessLogs/deleteItems",
                            data: {
                                checkIds: function () {
