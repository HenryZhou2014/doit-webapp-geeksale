...
<head>
    ...
    <style type="text/css">
        ...
        .form-control-feedback, .bv-form .help-block{
            color: darkred;
        }
    </style>
</head>
        ...
        <div class="col-lg-12 margin-bottom-80">
            ...
            <div class="tab-content margin-top-20">
                <div class="tab-pane fade in active" id="tab1">
                    ...
                    <form:form commandName="account" cssClass="form" name="accountApplyForm" action="memberApply" method="post" id="accountApplyForm">
                        <div class="row">
                            <div class="col-lg-2">
            ...
            fields: {
                accountName: {
                    ...
                    validators: {
                        ...
                        remote: {
                            type: 'GET',
                            url: "${ctx}/agent/checkEmployeeInfo",
                            data: {
